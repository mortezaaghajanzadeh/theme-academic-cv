...
image:
  ...
  caption: "Exit rate, market concentration (HHI), and number of companies by VC market density"
  placement: 1
design:
  columns: "1"
  css_class: "justify-text"
summary: >
  This paper develops a dynamic model of venture capital networks to study how financial intermediation shapes startup performance and market entry. It highlights three key mechanisms—assortative matching, value-added support, and entry deterrence through coordinated behavior—showing how networks can both improve efficiency and restrict competition.
# awards: >
